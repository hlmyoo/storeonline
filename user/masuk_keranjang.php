...
<div class="row">
   <div class="col">
   <img src="../petugas/foto/<?=$data_produk['foto_produk']?>" style="width:200px;height:215px; margin-left:30px; border-radius:10%;" alt="">
   </div>
   <div class="col">
        ...
        <hr style="color:black;">
        <p style="color:black;"><?=$data_produk['deskripsi']?></p>
    </div>
    <div class="col">
