...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <?php
         include'koneksi.php';
         $qry_produk=mysqli_query($koneksi,"select * from transaksi where id_transaksi = '".$_GET['id_transaksi']."'");
         $data_produk=mysqli_fetch_array($qry_produk);
         ?>
<div class="row">
   <div class="col">
   <img src="foto/<?=$data_produk['foto_produk']?>" style="width:350px;height:350px; margin-left:30px; border-radius:10%;" alt="">
   </div>
   <div class="col">
