...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
            <span style="color:yellow;  font-size: 40px;" ><?=$_SESSION['nama']?></span>
        ...
        <div class="container">
        <div class="card">
            <h1 class="card-header" style="color:black;">Tambah Barang</h1>
            <div class="card-body">
                <form method="POST" action="proses_tambah_barang.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_produk" placeholder="Masukkan Nama Barang" required>
                    </div>
                    <div class="mb-3">
